...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .setup(|app| {
            ...
            // 内网穿透模块（frp）：登录态装载 + TLS 客户端就绪
            app.manage(frp::frp_local::TunnelHandle::default());
            app.manage(frp::lolia::LoliaHandle::default());
            app.manage(frp::sakura::SakuraHandle::default());
            app.manage(frp::openfrp::OpenfrpHandle::default());
            frp::lolia::init(app.handle());
            frp::sakura::init(app.handle());
            frp::openfrp::init(app.handle());
            // 内置 frpc.exe（编译期打进 exe）解压到资源目录，供穿透模块使用
            frp::ensure_bundled_frpc(app.handle());
            println!("[boot] frp modules ready");
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            // AI 对话代理
            ai::ai_chat,
            // MC 服务器状态查询（工具箱·测试服务器）
            server_query::tool_server_query,
            // 私人服务器管理
            ...
            // 本地插件包（离线安装）
            plugins::plugin_local_inspect,
            plugins::plugin_install_local,
            ...
            // 内网穿透（frp）：本地 frpc + LoliaFRP / OpenFrp / SakuraFrp
            frp::frp_local::frp_local_start,
            frp::frp_local::frp_local_stop,
            frp::frp_local::frp_local_status,
            frp::frp_local::frp_local_logs,
            frp::frp_local::frp_local_clear_logs,
            frp::frp_local::frp_local_frpc_info,
            frp::lolia::lolia_oauth_begin,
            frp::lolia::lolia_oauth_status,
            frp::lolia::lolia_oauth_cancel,
            frp::lolia::lolia_auth_status,
            frp::lolia::lolia_logout,
            frp::lolia::lolia_user_info,
            frp::lolia::lolia_tunnel_list,
            frp::lolia::lolia_tunnel_detail,
            frp::lolia::lolia_tunnel_create,
            frp::lolia::lolia_tunnel_update,
            frp::lolia::lolia_tunnel_delete,
            frp::lolia::lolia_frpc_config,
            frp::lolia::lolia_token_config,
            frp::lolia::lolia_nodes,
            frp::lolia::lolia_domains,
            frp::lolia::lolia_domain_add,
            frp::lolia::lolia_domain_verify,
            frp::lolia::lolia_domain_delete,
            frp::lolia::lolia_traffic_stats,
            frp::lolia::lolia_traffic_daily,
            frp::lolia::lolia_traffic_tunnels,
            frp::lolia::lolia_traffic_tunnel,
            frp::lolia::lolia_client_version,
            frp::lolia::lolia_tunnel_run,
            frp::lolia::lolia_tunnel_run_by_token,
            frp::lolia::lolia_tunnel_stop,
            frp::lolia::lolia_run_status,
            frp::lolia::lolia_tunnel_logs,
            frp::lolia::lolia_tunnel_clear_logs,
            frp::openfrp::openfrp_auth_status,
            frp::openfrp::openfrp_login_start,
            frp::openfrp::openfrp_login_poll,
            frp::openfrp::openfrp_logout,
            frp::openfrp::openfrp_user_info,
            frp::openfrp::openfrp_nodes,
            frp::openfrp::openfrp_tunnel_list,
            frp::openfrp::openfrp_tunnel_create,
            frp::openfrp::openfrp_tunnel_edit,
            frp::openfrp::openfrp_tunnel_delete,
            frp::openfrp::openfrp_client_info,
            frp::openfrp::openfrp_frpc_info,
            frp::openfrp::openfrp_frpc_download_info,
            frp::openfrp::openfrp_frpc_install,
            frp::openfrp::openfrp_frpc_remove,
            frp::openfrp::openfrp_tunnel_start,
            frp::openfrp::openfrp_tunnel_stop,
            frp::openfrp::openfrp_run_status,
            frp::openfrp::openfrp_tunnel_logs,
            frp::openfrp::openfrp_tunnel_clear_logs,
            frp::sakura::sakura_auth_status,
            frp::sakura::sakura_login,
            frp::sakura::sakura_logout,
            frp::sakura::sakura_user_info,
            frp::sakura::sakura_nodes,
            frp::sakura::sakura_tunnel_list,
            frp::sakura::sakura_tunnel_create,
            frp::sakura::sakura_tunnel_edit,
            frp::sakura::sakura_tunnel_delete,
            frp::sakura::sakura_tunnel_config,
            frp::sakura::sakura_frpc_info,
            frp::sakura::sakura_frpc_remove,
            frp::sakura::sakura_tunnel_start,
            frp::sakura::sakura_tunnel_stop,
            frp::sakura::sakura_run_status,
            frp::sakura::sakura_tunnel_logs,
            frp::sakura::sakura_tunnel_clear_logs,
        ])
        .on_window_event(|window, event| {
            ...
            if window.label() == "main" {
                if let tauri::WindowEvent::Destroyed = event {
                    ...
                    // 内网穿透：杀掉所有 frpc 子进程，避免留下孤儿进程
                    crate::frp::frp_local::shutdown(&window.app_handle());
                    crate::frp::lolia::shutdown(&window.app_handle());
                    crate::frp::sakura::shutdown(&window.app_handle());
                    crate::frp::openfrp::shutdown(&window.app_handle());
                }
            }
        })
