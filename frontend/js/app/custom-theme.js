...
function generateCustomThemeVars(hex, isLight = false) {
  ...
  if (isLight) {
    return {
      ...
      '--bg-glass': `hsl(${Math.round(h)}, ${Math.round(bgSat)}%, 96%)`,
      '--bg-card-glass': `hsl(${Math.round(h)}, ${Math.round(bgSat)}%, 97%)`,
      ...
      '--sidebar-bg-solid': `hsl(${Math.round(h)}, ${Math.round(bgSat)}%, 96%)`
    };
  }
  ...
  return {
    ...
    '--bg-glass': `hsl(${Math.round(h)}, ${Math.round(bgSat)}%, 8%)`,
    '--bg-card-glass': `hsl(${Math.round(h)}, ${Math.round(bgSat)}%, 12%)`,
    ...
    '--sidebar-bg-solid': `hsl(${Math.round(h)}, ${Math.round(bgSat)}%, 10%)`
  };
}
