...
var ANNOUNCEMENT_CONTENT = {
    version: '1.0.1',
    title: 'VersePC-CE v1.0.1 预览版公告',
    body: `
        <div class="announcement-section">
            <p style="font-size:16px;line-height:1.8;">亲爱的小伙伴们，VersePC-CE 启动器正式开放<strong>预览版</strong>啦！</p>
...
async function showAnnouncementModal(forceShow) {
    try {
        // 更新器已移除：直接向后端取应用版本号（Tauri 返回字符串）
        var ver = await (window.__TAURI__ && window.__TAURI__.core
            ? window.__TAURI__.core.invoke('get_app_version')
            : Promise.resolve(null));
        var currentVersion = ver ? String(ver) : '1.0.0';
    } catch (e) {
